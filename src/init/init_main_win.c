...
/*   Updated: 2019/09/04 09:50:01 by ilyabaturin      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void
	init_main_win(t_sdl_data *data, char *name)
{
	t_win		*win;
	t_element	*button;
	t_element	*elem;
	...
	ui_add_win(win = ui_init_win(data, ft_strdup(name), (t_rect){200, 200, 640, 480},
	...
	button = ui_init_element(ft_intnew(1), "file", (t_rect){0, 0, 50, 50}, win, "button1", NULL, NULL, NULL,
						NULL, &image_draw, &set_active_btn_figs, NULL, NULL, NULL, &unset_drawtype);
	add_element_to_win(win, button);
	text = ui_init_element(ft_intnew(1), "text_save", (t_rect){10, 10, 30, 30}, win, NULL, NULL,
	...
	elem = ui_init_element(ft_intnew(0), "btn_clear", (t_rect){0, 50, 50, 50}, win, "button1", NULL, NULL, NULL,
						NULL, &image_draw, &clear_cur_layer, NULL, NULL, NULL, NULL);
	add_element_to_win(win, elem);
	text = ui_init_element(ft_intnew(1), "text_clear", (t_rect){10, 10, 30, 30}, win, NULL, NULL,
	...
	elem = ui_init_element(ft_intnew(0), "btn_save", (t_rect){0, 100, 50, 50}, win, "button1", NULL, NULL, NULL,
