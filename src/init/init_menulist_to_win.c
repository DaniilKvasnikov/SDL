...
/*   Updated: 2019/08/17 03:26:05 by rrhaenys         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
		...
		int (*draw_elem)(void *win, void *elem))
{
	...
	while (strs[++i] != NULL)
	{
		button = init_dropdownlist_to_win((t_rect){rect.x + rect.w * i, rect.y + rect.h, rect.w, rect.h}, path_tex, win, strs, strs[i], button_pressed, active_elem, draw, draw_elem);
