...
/*   Updated: 2019/08/26 13:34:11 by rrhaenys         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	add_buttons_figures(t_element *button, t_win *win)
{
	...
	but = ui_init_element(0, "figure1", (t_rect){0, 100, 50, 50}, win, "button1", NULL, NULL, NULL,
	...
	but = ui_init_element(0, "figure2", (t_rect){50, 100, 50, 50}, win, "button1", NULL, NULL, NULL,
	...
	but = ui_init_element(0, "figure3", (t_rect){0, 150, 50, 50}, win, "button1", NULL, NULL, NULL,
	...
	but = ui_init_element(0, "figure4", (t_rect){50, 150, 50, 50}, win, "button1", NULL, NULL, NULL,
	...
	init_ptool_win(char *name)
{
	...
	figures = ui_init_element(1, "button4", (t_rect){50, 50, 50, 50}, win, "button1", NULL, NULL, NULL,
	...
	elem = ui_init_element(1, "button5", (t_rect){0, 100, 50, 50}, win, "cat", NULL, NULL, NULL,
