...
/*   Updated: 2019/08/26 17:55:17 by ilyabaturin      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	add_buttons_figures(t_element *button, t_win *win)
{
	...
	but = ui_init_element(0, "figure1", (t_rect){0, 150, 50, 50}, win, "button1", NULL, NULL, NULL,
	...
	but = ui_init_element(0, "figure2", (t_rect){50, 150, 50, 50}, win, "button1", NULL, NULL, NULL,
	...
	but = ui_init_element(0, "figure3", (t_rect){0, 200, 50, 50}, win, "button1", NULL, NULL, NULL,
						NULL, &image_draw, &set_drawtype_elipse, NULL, NULL, NULL, NULL);
	add_element_to_win(win, but);
	image = ui_init_element(1, "text_sphere_image", (t_rect){10, 10, 30, 30}, win, NULL, NULL,
	...
	but = ui_init_element(0, "figure4", (t_rect){50, 200, 50, 50}, win, "button1", NULL, NULL, NULL,
						NULL, &image_draw, &set_drawtype_elipsefilled, NULL, NULL, NULL, NULL);
	add_element_to_win(win, but);
	image = ui_init_element(1, "text_sphere_fil_image", (t_rect){10, 10, 30, 30}, win, NULL, NULL,
	...
	init_ptool_win(char *name)
{
	...
	elem = ui_init_element(1, "button_hand", (t_rect){0, 0, 50, 50}, win, "button1", NULL, NULL, NULL,
						NULL, &image_draw, &set_drawtype_nodraw, NULL, NULL, NULL, NULL);
	add_element_to_win(win, elem);
	image = ui_init_element(1, "text_nodraw", (t_rect){10, 10, 30, 30}, win, NULL, NULL,
						ft_colornew((t_color){255, 0, 0, 255}), "hand",
						NULL, &render_text, NULL, NULL, NULL, NULL, NULL);
	image->ttf = get_ttf_by_name("standart", 14);
	add_element_draw_to_win(elem, image);
	elem = ui_init_element(1, "button1", (t_rect){0, 50, 50, 50}, win, "button1", NULL, NULL, NULL,
	...
	add_element_draw_to_win(elem, image);
	elem = ui_init_element(1, "button2", (t_rect){50, 50, 50, 50}, win, "button1", NULL, NULL, NULL,
	...
	image = ui_init_element(1, "eraser_image", (t_rect){10, 10, 30, 30}, win, "eraser", NULL, NULL, NULL,
						NULL, &image_draw, NULL, NULL, NULL, NULL, NULL);
	add_element_draw_to_win(elem, image);
	elem = ui_init_element(1, "button3", (t_rect){0, 100, 50, 50}, win, "button1", NULL, NULL, NULL,
	...
	figures = ui_init_element(1, "button4", (t_rect){50, 100, 50, 50}, win, "button1", NULL, NULL, NULL,
	...
	elem = ui_init_element(1, "button5", (t_rect){0, 150, 50, 50}, win, "cat", NULL, NULL, NULL,
						NULL, &image_draw, &set_drawtype_texture, NULL, NULL, NULL, NULL);
	add_element_to_win(win, elem);

	elem = ui_init_element(1, "button6", (t_rect){50, 150, 50, 50}, win, "cat2", NULL, NULL, NULL,
						NULL, &image_draw, &set_drawtype_texture, NULL, NULL, NULL, NULL);
	add_element_to_win(win, elem);

	elem = ui_init_element(1, "button7", (t_rect){0, 200, 50, 50}, win, "cat3", NULL, NULL, NULL,
						NULL, &image_draw, &set_drawtype_texture, NULL, NULL, NULL, NULL);
	add_element_to_win(win, elem);
}
