...
/*   Updated: 2019/08/14 12:39:28 by rrhaenys         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	return (add_element_to_win(win, init_element(rect, path_tex1, path_tex2, win, NULL, NULL, button_pressed, NULL, NULL, draw)));
}
